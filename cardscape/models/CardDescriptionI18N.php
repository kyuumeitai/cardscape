...
/**
 * This is the model class for table "CardDescriptionI18N".
 *
 * The followings are the available columns in table 'CardDescriptionI18N':
 * @property integer $id
...
class CardNameI18N extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'string' => Yii::t('cardscape', 'Description'),
